...
Each lab's own tab holds the detail: a row per hand-in — when, name, class, score, %,
whether it was finished, **how many checks it took**, **how many were right first time**, and
how long they had been working. Those last three are the point of the record:
